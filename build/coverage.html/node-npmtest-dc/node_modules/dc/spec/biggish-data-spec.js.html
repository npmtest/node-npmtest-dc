...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-dc/node_modules/dc/spec/biggish-data-spec.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-dc/node_modules/dc/spec/biggish-data-spec.js</span></h1>
    <h2>
        
        Statements: <span class="metric">3.7% <small>(2 / 54)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">3.92% <small>(2 / 51)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-dc/node_modules/dc/spec/</a> &#187; biggish-data-spec.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        appendChartID('stack-chart');</span>
<span class="cstat-no" title="statement not covered" >        appendChartID('range-chart');</span>
<span class="cstat-no" title="statement not covered" >        var chartAttemptSeries = dc.lineChart('#stack-chart');</span>
<span class="cstat-no" title="statement not covered" >        var chartRange = dc.barChart('#range-chart');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var dateFormat = d3.time.format.iso;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var xfilter;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var data = biggishData();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        data.forEach(<span class="fstat-no" title="function not covered" >function (row) {</span></span>
            // coerce k(ind) into a number
<span class="cstat-no" title="statement not covered" >            row.k = +row.k;</span>
            // convert event time into d3 date format
<span class="cstat-no" title="statement not covered" >            row.dd = dateFormat.parse(row.t);</span>
            // pre-calculate the day of the time
<span class="cstat-no" title="statement not covered" >            row.day = d3.time.day(row.dd);</span>
            // precalculate the hour of the time
<span class="cstat-no" title="statement not covered" >            row.hour = d3.time.hour(row.dd);</span>
            // coerce n(umber of attempts) into a number
<span class="cstat-no" title="statement not covered" >            row.n = +row.n;</span>
        });
&nbsp;
<span class="cstat-no" title="statement not covered" >        xfilter = crossfilter(data);</span>
&nbsp;
        // hour dimension (across all kinds)
<span class="cstat-no" title="statement not covered" >        var dimHour = xfilter.dimension(<span class="fstat-no" title="function not covered" >function (row) {</span> <span class="cstat-no" title="statement not covered" >return row.hour; </span>});</span>
&nbsp;
        // grouping used by the range chart (sum of number of attempts for all kinds per hour)
<span class="cstat-no" title="statement not covered" >        var groupHourSum = dimHour.group().reduceSum(<span class="fstat-no" title="function not covered" >function (row) {</span> <span class="cstat-no" title="statement not covered" >return row.n; </span>});</span>
&nbsp;
        // groupings used by the stacked bar chart (one value for each kind)
<span class="cstat-no" title="statement not covered" >        var groupHourSeries = dimHour.group().reduce(</span>
<span class="fstat-no" title="function not covered" >            function (p, v) {</span>
<span class="cstat-no" title="statement not covered" >                switch (v.k) {</span>
                    case 1:
<span class="cstat-no" title="statement not covered" >                        p.hma += v.n;</span>
<span class="cstat-no" title="statement not covered" >                        break;</span>
                    case 2:
<span class="cstat-no" title="statement not covered" >                        p.bfa += v.n;</span>
<span class="cstat-no" title="statement not covered" >                        break;</span>
                    case 3:
<span class="cstat-no" title="statement not covered" >                        p.uha += v.n;</span>
<span class="cstat-no" title="statement not covered" >                        break;</span>
                } // switch
...
<span class="cstat-no" title="statement not covered" >        var extentDay = d3.extent(data, <span class="fstat-no" title="function not covered" >function (row) {</span> <span class="cstat-no" title="statement not covered" >return row.day; </span>});</span>
        // select the following day for the end of the extent
<span class="cstat-no" title="statement not covered" >        extentDay[1] = d3.time.day.offset(extentDay[1], 1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        chartAttemptSeries</span>
...
<span class="cstat-no" title="statement not covered" >        chartAttemptSeries</span>
            ...
            .valueAccessor(<span class="fstat-no" title="function not covered" >function (d) {</span> <span class="cstat-no" title="statement not covered" >return d.value.bfa; </span>})
            .stack(groupHourSeries, 'Horizontal Movement', <span class="fstat-no" title="function not covered" >function (d) {</span> <span class="cstat-no" title="statement not covered" >return d.value.hma; </span>})
            .stack(groupHourSeries, 'User Account Hacking', <span class="fstat-no" title="function not covered" >function (d) {</span> <span class="cstat-no" title="statement not covered" >return d.value.uha; </span>})
            .xUnits(d3.time.hours);
&nbsp;
<span class="cstat-no" title="statement not covered" >        chartAttemptSeries.legend(dc.legend().horizontal(true).x(50).y(0).itemWidth(150).gap(5));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        chartRange</span>
            .height(80)
            .dimension(dimHour)
            .group(groupHourSum)
            .centerBar(true)
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    describe('smoke test for #909', <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        it('doesn\'t die', <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            expect(true).toBeTruthy();</span>
        });
    });
});
&nbsp;
